...
@section('title', 'BoePortal | Baca Berita')
      ...
      <div class="swiper-wrapper">
        ...
        @foreach ($banners as $banner)
          ...
          <a href="detail-MotoGp.html" class="block">
            <div class="relative flex flex-col gap-1 justify-end p-3 h-72 rounded-xl bg-cover bg-center overflow-hidden" style="background-image: url('{{ asset('storage/' . $banner->news->thumbnail) }}') ">
